...
![Схема](https://github.com/DICHDN/Psql/blob/main/Music%20-%20public.png)

Create.sql - фаил создания таблиц БД

Insert.sql - фаил заполнения таблиц БД

SELECT.SQL - фаил запросов согласно заданий (10 запросов в коментах задание для каждого)